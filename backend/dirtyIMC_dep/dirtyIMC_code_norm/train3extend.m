...
TmpXb(isnan(TmpXb))=0; TmpXb(isinf(TmpXb))=0;
TmpYb(isnan(TmpYb))=0; TmpYb(isinf(TmpYb))=0;

TmpXa(isnan(TmpXa))=0; TmpXa(isinf(TmpXa))=0;
TmpYa(isnan(TmpYa))=0; TmpYa(isinf(TmpYa))=0;

TmpX(isnan(TmpX))=0; TmpX(isinf(TmpX))=0;
TmpY(isnan(TmpY))=0; TmpY(isinf(TmpY))=0;


TmpX = [TmpX/norm(TmpX) TmpXa/norm(TmpXa) TmpXb/norm(TmpXb)];
TmpY = [TmpY/norm(TmpY) TmpYa/norm(TmpYa) TmpYb/norm(TmpYb)];
