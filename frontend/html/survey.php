    ...
    <form name="survey" method="POST" action="survey_submit.php" onsubmit="return validateForm();" accept-charset="UTF-8">
        ...
        <fieldset class="section" id="part-2">
            ...
            <fieldset class="question survey" name="survey-q2">
                ...
                <input type="radio" name="survey-q4" id="survey-q2-input-1" value="1" required><label
                        for="survey-q2-input-1">1 (No)</label>
                <input type="radio" name="survey-q4" id="survey-q2-input-2" value="2"><label
                        for="survey-q2-input-2">2</label>
                <input type="radio" name="survey-q4" id="survey-q2-input-3" value="3"><label
                        for="survey-q2-input-3">3</label>
                <input type="radio" name="survey-q4" id="survey-q2-input-4" value="4"><label
                        for="survey-q2-input-4">4</label>
                <input type="radio" name="survey-q4" id="survey-q2-input-5" value="5"><label
            ...
            <fieldset class="question survey" name="survey-q3">
                ...
                <input type="radio" name="survey-q2" id="survey-q3-input-1" value="1" required><label
                        for="survey-q3-input-1">1 (None)</label>
                <input type="radio" name="survey-q2" id="survey-q3-input-2" value="2"><label
                        for="survey-q3-input-2">2</label>
                <input type="radio" name="survey-q2" id="survey-q3-input-3" value="3"><label
                        for="survey-q3-input-3">3</label>
                <input type="radio" name="survey-q2" id="survey-q3-input-4" value="4"><label
                        for="survey-q3-input-4">4</label>
                <input type="radio" name="survey-q2" id="survey-q3-input-5" value="5"><label
