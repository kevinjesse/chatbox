...
<section id="form">
    <form name="survey" method="POST" action="survey_submit.php" onsubmit="return validateForm();" accept-charset="UTF-8">
        ...
        <fieldset class="section" name="turkID">
            ...
            <input type="text" name="turkID" id="turkid-input">
        </fieldset>
        <fieldset class="section" id="part-1">
            ...
            for($i = 0; $i < count($history); $i++) {
                ...
                echo '<input type="radio" name="rating-q' . ($i + 1) . '" id="rating-q' . ($i + 1) . '-input-1" value="1">';
        ...
        <fieldset class="section" id="part-2">
            ...
            <fieldset class="question" name="survey-q1">
                ...
                <input type="radio" name="survey-q1" id="survey-q1-input-1" value="1"><label for="survey-q1-input-1">Yes</label>
            ...
            <fieldset class="question survey" name="survey-q2">
                ...
                <input type="radio" name="survey-q2" id="survey-q2-input-1" value="1"><label for="survey-q2-input-1">1 (None)</label>
            ...
            <fieldset class="question survey" name="survey-q3">
                ...
                <textarea name="survey-q3" id="survey-q3-input-1"></textarea>
                </div>
            </fieldset>
